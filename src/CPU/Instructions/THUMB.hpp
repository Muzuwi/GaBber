...
#undef PATTERN
	...
	public:
		...
		uint16 raw() const { return m_data; }

		uint8 opcode() const { return (m_data >> 11u) & 0b11; }

		uint8 immediate() const { return (m_data >> 6u) & 0b11111; }

		uint8 source_reg() const { return (m_data >> 3u) & 0b111; }

		uint8 destination_reg() const { return (m_data)&0b111; }
	};
	...
	public:
		...
		bool immediate_is_value() const { return m_data & (1u << 10u); }

		bool subtract() const { return m_data & (1u << 9u); }

		uint8 immediate() const { return (m_data >> 6u) & 0b111; }
	...
	public:
		...
		uint8 target_reg() const { return (m_data >> 8u) & 0b111; }
	...
	public:
		...
		uint8 opcode() const { return (m_data >> 6u) & 0xF; }

		uint8 source_reg() const { return (m_data >> 3u) & 0b111; }

		uint8 target_reg() const { return m_data & 0b111; }
	};
	...
	public:
		...
		uint8 opcode() const { return (m_data >> 8u) & 0b11; }

		bool MSBd() const { return m_data & (1u << 7u); }

		bool MSBs() const { return m_data & (1u << 6u); }

		uint8 source_reg() const { return ((m_data >> 3u) & 0b111) | (MSBs() ? 0x8 : 0); }

		uint8 destination_reg() const { return ((m_data)&0b111) | (MSBd() ? 0x8 : 0); }
	};
	...
	public:
		...
		uint8 destination_reg() const { return (m_data >> 8u) & 0b111u; }
	...
	public:
		...
		bool load_from_memory() const { return m_data & (1u << 11u); }

		bool quantity_in_bytes() const { return m_data & (1u << 10u); }

		uint8 offset_reg() const { return (m_data >> 6u) & 0b111; }

		uint8 base_reg() const { return (m_data >> 3u) & 0b111; }
	...
	public:
		...
		bool h_flag() const { return m_data & (1u << 11u); }

		uint8 opcode() const { return (m_data >> 10u) & 0b11u; }

		bool operand_sign_extended() const { return m_data & (1u << 10u); }
	...
	public:
		...
		bool quantity_in_bytes() const { return m_data & (1u << 12u); }

		uint8 offset() const { return (m_data >> 6u) & 0b11111; }
	...
	public:
		...
		uint8 destination_reg() const { return (m_data >> 8u) & 0b111; }
	...
	public:
		...
		bool source_is_sp() const { return m_data & (1u << 11u); }
	...
	public:
		...
		bool offset_is_negative() const { return m_data & (1u << 7u); }

		uint8 offset() const { return m_data & 0b1111111; }
	};
	...
	public:
		...
		bool store_lr_load_pc() const { return m_data & (1u << 8u); }
	...
	public:
		...
		uint8 base_reg() const { return (m_data >> 8u) & 0b111; }
		...
		bool is_rlist_empty() const { return (m_data & 0xFF) == 0; }

		bool is_register_first_in_rlist(uint8 reg) const { return std::countr_zero(m_data & 0xFFu) == reg; }
	...
	public:
		...
		int8 offset() const { return m_data & 0xFF; }
	};
	...
	public:
		...
		uint8 comment() const { return m_data & 0xFF; }
	};
	...
	public:
		...
		uint16 offset() const { return m_data & 0x7ff; }
	};
	...
	public:
		...
		bool low() const { return m_data & (1u << 11u); }
